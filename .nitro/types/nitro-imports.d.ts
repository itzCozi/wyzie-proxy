declare global {
  ...
  const getAfterResponseHeaders: typeof import('../../src/utils/headers.ts')['getAfterResponseHeaders']
  const getBlacklistedHeaders: typeof import('../../src/utils/headers.ts')['getBlacklistedHeaders']
  const getBodyBuffer: typeof import('../../src/utils/body.ts')['getBodyBuffer']
  ...
  const getProxyHeaders: typeof import('../../src/utils/headers.ts')['getProxyHeaders']
  ...
  const hasBody: typeof import('../../src/utils/body.ts')['hasBody']
  ...
  const sendJson: typeof import('../../src/utils/sending.ts')['sendJson']
  ...
  const specificProxyRequest: typeof import('../../src/utils/proxy.ts')['specificProxyRequest']
...
declare global {
  // @ts-ignore
  export type { ExtraProxyOptions } from '../../src/utils/proxy.ts'
  import('../../src/utils/proxy.ts')
}
